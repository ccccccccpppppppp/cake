...
function getResult(){
	var option1 = document.getElementById('caketype').value;
	var option2 = document.getElementById('cakesize').value;
	var option3 = document.getElementById('cakeform').value;
